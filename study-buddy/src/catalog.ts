...
import { classAppMeta as osuFpst1213 } from '../apps/osu-fpst-1213/meta';
...
export const CLASS_APPS: ClassAppListing[] = [
  ...
  occcBioAp,
  {
    id: 'econ-micro-study-buddy',
    slug: 'econ-micro-study-buddy',
    title: 'OSU Micro for Business Study Buddy',
    shortTitle: 'Micro (Business)',
    courseCodes: ['ECON 2003'],
    school: 'Oklahoma State University · Spears',
    subject: 'Microeconomic Principles for Business',
    description:
      'McLean-style 3 unit exams + final (Connect Master / Asarta-Butters). Unit 1 markets, Unit 2 firms, Unit 3 factor markets + intro cycles/trade. Tutor walkthroughs after every MCQ.',
    status: 'live',
    path: '/econ-micro-study-buddy/',
    externalHref: 'econ-micro-study-buddy/',
    color: 'orange',
    version: '1.3.0',
    tags: ['economics', 'micro', 'OSU', 'ECON 2003', 'Spears', 'business', 'McLean'],
  },
  {
    id: 'econ-macro-study-buddy',
    slug: 'econ-macro-study-buddy',
    title: 'OSU Macro for Business Study Buddy',
    shortTitle: 'Macro (Business)',
    courseCodes: ['ECON 2203'],
    school: 'Oklahoma State University · Spears',
    subject: 'Introduction to Macroeconomics (business sequence)',
    description:
      '3 unit exams + final mapped to Connect Master macro modules: measurement, AD–AS/fiscal, money/Fed/open economy. Tutor walkthroughs after every MCQ.',
    status: 'live',
    path: '/econ-macro-study-buddy/',
    externalHref: 'econ-macro-study-buddy/',
    color: 'cyan',
    version: '1.3.0',
    tags: ['economics', 'macro', 'OSU', 'ECON 2203', 'Spears', 'business'],
  },
  {
  ...
  {
    id: 'pe-fpe-study-buddy',
    slug: 'pe-fpe-study-buddy',
    title: 'PE Fire Protection Practice Exams',
    shortTitle: 'PE FPE',
    courseCodes: ['PE Fire Protection', 'April 2027'],
    school: 'NCEES PE (personal study)',
    subject: 'Full-length CBT dress rehearsal · 2027 specs',
    description:
      'Three original 85-item forms (A/B/C) that copy the April 2027 PE Fire Protection CBT format. Keep-sharp reinforcement for topics you already hit. Not an NCEES exam. No fake cut score.',
    status: 'beta',
    path: '/pe-fpe-study-buddy/',
    externalHref: 'pe-fpe-study-buddy/',
    color: 'red',
    version: '0.1.0',
    tags: ['PE', 'NCEES', 'fire protection', 'FPE', 'CBT', 'NFPA 855', 'handbook'],
  },
  {
