  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {sessionReviewed > 0 && (
          <span className="badge bg-orange-50 text-orange-800 dark:bg-orange-950 dark:text-orange-300">
        ...
        <>
          ...
          <div className="flip-card mx-auto h-64 w-full max-w-xl sm:h-72">
            ...
            >
              ...
              <div className="flip-card-face flip-card-back card flex flex-col items-center justify-center bg-orange-50 p-6 text-center shadow-md dark:bg-orange-950/40">
          ...
          <div className="mx-auto flex max-w-xl flex-col gap-3">
            {!flipped ? (
              ...
              <div className="grid grid-cols-3 gap-2" role="group" aria-label="Rate card difficulty">
                ...
                <button
                  type="button"
                  className="btn bg-orange-100 text-orange-900 hover:bg-orange-200 dark:bg-orange-950 dark:text-orange-200"
                  onClick={() => rate('easy')}
                >
