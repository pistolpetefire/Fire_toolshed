  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm font-medium text-emerald-700 dark:text-emerald-400">Exam 1 · Chs 1–4 · Fri Sep 4</p>
        <h1 className="page-title">Exam 1 study guide</h1>
        <p className="page-subtitle">
          24 prompts aligned to Haggard’s learning goals. Tap to reveal a model answer; check it off only when you can
                  ...
                  <li key={item.id} className="card overflow-hidden">
                    <div className="flex items-start gap-2 p-3 sm:p-4">
                      ...
                      >
                        ...
                        {open && (
                          <p className="mt-2 rounded-xl bg-emerald-50 p-3 text-sm text-slate-700 dark:bg-emerald-950/40 dark:text-slate-200">
                            <BookOpen className="mb-1 inline h-3.5 w-3.5 text-emerald-600" /> {item.answer}
                          </p>
                        )}
                      </button>
