...
export function UnitDetail() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link to={p('/units')} className="mb-3 inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-emerald-700">
...
function UnitStepper({
  ...
  return (
    <div className="card p-3 sm:p-4">
      <div className="mb-3">
        <ProgressBar label="Chapter mastery" value={mastery} max={100} size="sm" color="bg-emerald-500" />
      </div>
