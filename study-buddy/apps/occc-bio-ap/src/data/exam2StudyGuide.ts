...
export const exam2LabelingQuestions: LabelingQuestion[] = [
  {
    ...
    systemId: 'integumentary',
    diagramId: 'osmosis',
    prompt: 'Tap the hypotonic RBC (water in → lyse).',
    structureId: 'osm-hypotonic',
    structureName: 'Hypotonic (lyse)',
    distractors: ['Isotonic', 'Hypertonic (crenate)'],
    explanation: 'Instructor tonicity plate. Hypotonic ECF: water enters, cell swells/bursts.',
  ...
  },
  {
    ...
    systemId: 'integumentary',
    diagramId: 'osmosis',
    prompt: 'Tap the isotonic RBC (no net water shift).',
    structureId: 'osm-isotonic',
    structureName: 'Isotonic',
    distractors: ['Hypotonic (lyse)', 'Hypertonic (crenate)'],
    explanation: 'Normal biconcave disc when ECF matches ICF tonicity.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-hypertonic',
    ...
    systemId: 'integumentary',
    diagramId: 'osmosis',
    prompt: 'Tap the hypertonic RBC (water out → crenate).',
    structureId: 'osm-hypertonic',
    structureName: 'Hypertonic (crenate)',
    distractors: ['Hypotonic (lyse)', 'Isotonic'],
    explanation: 'Hypertonic ECF pulls water out. Cell shrivels.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-ssq',
  ...
  },
  {
    ...
    type: 'diagram-labeling',
    systemId: 'integumentary',
    diagramId: 'skeletal-muscle',
    prompt: 'Tap the skeletal muscle fiber (striated, multinucleate).',
    structureId: 'skm-fiber',
    structureName: 'Skeletal muscle fiber',
    distractors: ['Cardiac muscle fiber', 'Smooth muscle cell'],
    explanation: 'Instructor skeletal-muscle micrograph. Heavy striations; somatic control.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-cam',
    type: 'diagram-labeling',
    systemId: 'integumentary',
    diagramId: 'cardiac-muscle',
    prompt: 'Tap the cardiac muscle fiber (branched, intercalated discs).',
    structureId: 'cam-fiber',
    structureName: 'Cardiac muscle fiber',
    distractors: ['Skeletal muscle fiber', 'Smooth muscle cell'],
    explanation: 'Instructor cardiac micrograph. Branched fibers and intercalated discs.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-hyaline',
    type: 'diagram-labeling',
    systemId: 'integumentary',
    diagramId: 'hyaline-cartilage',
    prompt: 'Tap a chondrocyte in a lacuna (hyaline cartilage).',
    structureId: 'hyaline-chondrocyte',
    structureName: 'Chondrocyte in lacuna',
    distractors: ['Osteocyte', 'Erythrocyte'],
    explanation: 'Instructor hyaline slide. Cells sit in lacunae in a glassy matrix.',
    interactionMode: 'click-region',
  },
];
