...
export const exam2LabelingQuestions: LabelingQuestion[] = [
  ...
  },
  {
    ...
    systemId: 'integumentary',
    diagramId: 'na-k-pump',
    prompt: 'Tap the Na+/K+ pump protein.',
    structureId: 'nak-pump',
    structureName: 'Na+/K+ pump',
    distractors: ['Extracellular fluid', 'Intracellular fluid'],
    explanation: 'Primary active transport: 3 Na+ out, 2 K+ in.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-nak-ecf',
    ...
    systemId: 'integumentary',
    diagramId: 'na-k-pump',
    prompt: 'Tap the extracellular fluid on the pump figure.',
    structureId: 'nak-ecf',
    structureName: 'Extracellular fluid',
    distractors: ['Intracellular fluid', 'Na+/K+ pump'],
    explanation: 'Outside the cell. Na+ is pumped out here.',
    interactionMode: 'click-region',
  },
  {
    id: 'e2-lb-ssq',
