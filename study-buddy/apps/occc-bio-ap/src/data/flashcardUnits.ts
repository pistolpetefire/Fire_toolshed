...
export const unitFlashcardExtras: Flashcard[] = [
  ...
  { id: 'u1-fc-07', front: 'Why does spelling of anatomical terms matter on Senter exams?', back: 'A misspelling can name a different structure (ileum vs ilium). Misspelled required terms and missing L/R cost ¼ point each.', systemId: 'foundations', tags: ['unit-1', 'spelling'], unitIds: ['unit-1'] },
  { id: 'u1-fc-08', front: 'Nasal is _____ and _____ to otic. Tarsal is _____ to femoral.', back: 'Medial and anterior. Distal.', systemId: 'foundations', tags: ['unit-1', 'directional'], unitIds: ['unit-1'] },
  { id: 'u1-fc-09', front: 'Hallux, pollex, popliteal, olecranal, fibular?', back: 'Hallux = great toe. Pollex = thumb. Popliteal = posterior knee. Olecranal = posterior elbow. Fibular/peroneal = lateral leg.', systemId: 'foundations', tags: ['unit-1', 'regions'], unitIds: ['unit-1'] },
  { id: 'u1-fc-10', front: 'Sagittal vs frontal vs transverse planes?', back: 'Sagittal: right/left (midsagittal = equal). Frontal/coronal: anterior/posterior. Transverse: superior/inferior; cross-sections of tubes look like circles.', systemId: 'foundations', tags: ['unit-1', 'planes'], unitIds: ['unit-1'] },
  { id: 'u1-fc-11', front: 'Two subdivisions of the anterior body cavity? What splits them?', back: 'Thoracic and abdominopelvic. Diaphragm divides the ventral cavity.', systemId: 'foundations', tags: ['unit-1', 'cavities'], unitIds: ['unit-1'] },
  { id: 'u1-fc-12', front: 'Two portions of the posterior aspect?', back: 'Cranial cavity and vertebral (spinal) cavity.', systemId: 'foundations', tags: ['unit-1', 'cavities'], unitIds: ['unit-1'] },
  { id: 'u1-fc-13', front: 'Parietal vs visceral membrane?', back: 'Parietal lines the cavity wall (farther from the organ). Visceral covers the organ. Serous fluid is between them.', systemId: 'foundations', tags: ['unit-1', 'membranes'], unitIds: ['unit-1'] },
  { id: 'u1-fc-14', front: 'Ipsilateral vs contralateral? Proximal vs distal?', back: 'Ipsilateral = same side. Contralateral = opposite side. Proximal/distal are the limb terms (closer to / farther from the trunk).', systemId: 'foundations', tags: ['unit-1', 'directional'], unitIds: ['unit-1'] },
  { id: 'u1-fc-15', front: 'Which of brachial, pollex, olecranon, tarsal, antecubital is not upper extremity?', back: 'Tarsal (ankle). The rest are arm/thumb/posterior elbow/anterior elbow.', systemId: 'foundations', tags: ['unit-1', 'regions'], unitIds: ['unit-1'] },
  { id: 'u1-fc-16', front: 'Observation vs hypothesis vs theory vs law?', back: 'Observation: noticing. Hypothesis: testable prediction. Theory: well-supported explanation of why. Law: consistent description of what happens.', systemId: 'foundations', tags: ['unit-1', 'method'], unitIds: ['unit-1'] },
  ...
  { id: 'u2-fc-07', front: 'Na, K, Ca, Mg, phosphate, Cl, bicarbonate — symbols and charges?', back: 'Na+, K+, Ca2+, Mg2+, HPO4^2−, Cl−, HCO3−.', systemId: 'chemistry', tags: ['unit-2', 'ions'], unitIds: ['unit-2'] },
  { id: 'u2-fc-08', front: 'Four types of chemical bonds/forces?', back: 'Ionic (transfer), covalent (share; polar/nonpolar), hydrogen (between polar molecules), van der Waals (brief weak attractions).', systemId: 'chemistry', tags: ['unit-2', 'bonds'], unitIds: ['unit-2'] },
  { id: 'u2-fc-09', front: 'Metabolism vs catabolism vs anabolism?', back: 'Metabolism = all reactions. Catabolism = break down, release energy. Anabolism = build up, use energy.', systemId: 'chemistry', tags: ['unit-2', 'metabolism'], unitIds: ['unit-2'] },
  { id: 'u2-fc-10', front: 'If H+ is depleted in CO2 + H2O ↔ H2CO3 ↔ HCO3− + H+, which way does it shift?', back: 'Right, to make more H+. pH had risen; the buffer pulls it back down. If H+ rises, shift left.', systemId: 'chemistry', tags: ['unit-2', 'buffer'], unitIds: ['unit-2'] },
  { id: 'u2-fc-11', front: 'Mono / di / poly carbohydrate examples?', back: 'Mono: glucose, fructose, galactose. Di: sucrose, lactose, maltose. Poly: glycogen, starch, cellulose.', systemId: 'chemistry', tags: ['unit-2', 'carbs'], unitIds: ['unit-2'] },
  { id: 'u2-fc-12', front: 'Four lipid types in the body?', back: 'Triglycerides (energy), phospholipids (membranes), steroids (cholesterol/hormones), eicosanoids (prostaglandins).', systemId: 'chemistry', tags: ['unit-2', 'lipids'], unitIds: ['unit-2'] },
  { id: 'u2-fc-13', front: 'Nucleic acids in the body?', back: 'DNA; RNA (mRNA, tRNA, rRNA); ATP as the energy nucleotide.', systemId: 'chemistry', tags: ['unit-2', 'nucleic'], unitIds: ['unit-2'] },
  { id: 'u2-fc-14', front: 'Most common elements in the body?', back: 'O, C, H, N (bulk), plus Ca, P, K, S, Na, Cl, Mg.', systemId: 'chemistry', tags: ['unit-2', 'elements'], unitIds: ['unit-2'] },
