...
export const EXAM_BLOCKS: {
...
}[] = [
  {
    ...
    note: 'Official Unit One study guide (Ch 1–2) + body organization / terminology worksheet',
  },
  {
    id: 2,
    title: 'Exam 2',
...
export const courseUnits: CourseUnit[] = [
  {
    ...
    topics: [
      ...
      'Directional / regional terms, planes, cavities, serous membranes',
    ],
    ...
    objectives: [
      ...
      {
        number: 9,
        text: 'Use directional terms, regional terms, and body planes (from the Unit One study guide / terminology worksheet).',
        chapters: 'Ch 1, Appendix A',
      },
      {
        number: 10,
        text: 'Identify ventral/dorsal body cavities and parietal vs visceral serous membranes.',
        chapters: 'Ch 1, Appendix A',
      },
    ],
  },
