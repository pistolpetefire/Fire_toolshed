...
export const EXAM2_DIAGRAMS: Record<string, DiagramConfig> = {
  'animal-cell': {
    ...
    backgroundImage: 'unit/exam2-animal-cell.jpg',
    quizBackgroundImage: 'unit/exam2-animal-cell.jpg',
    renderStyle: 'hotspot',
  ...
  osmosis: {
    ...
    backgroundImage: 'unit/exam2-osmosis.jpg',
    quizBackgroundImage: 'unit/exam2-osmosis.jpg',
    renderStyle: 'hotspot',
  ...
  'na-k-pump': {
    ...
    backgroundImage: 'unit/exam2-na-k-pump.jpg',
    quizBackgroundImage: 'unit/exam2-na-k-pump.jpg',
    renderStyle: 'hotspot',
  ...
  epithelium: {
    ...
    backgroundImage: 'unit/exam2-epithelium-grid.jpg',
    quizBackgroundImage: 'unit/exam2-epithelium-grid.jpg',
    renderStyle: 'hotspot',
  ...
  'skeletal-muscle': {
    ...
    viewBox: '0 0 853 1438',
    imageWidth: 853,
    imageHeight: 1438,
    maxWidthClass: 'max-w-md',
    backgroundImage: 'unit/exam2-skeletal-muscle.jpg',
    quizBackgroundImage: 'unit/exam2-skeletal-muscle.jpg',
    renderStyle: 'hotspot',
    credit: credit('Skeletal muscle'),
    regions: [
      tap('skm-fiber', 'Skeletal muscle fiber', 430, 720, 80, 'Long multinucleate fiber. Heavy striations. Somatic control.', 'Muscle'),
    ],
  },
  ...
  'cardiac-muscle': {
    ...
    viewBox: '0 0 806 1369',
    imageWidth: 806,
    imageHeight: 1369,
    maxWidthClass: 'max-w-md',
    backgroundImage: 'unit/exam2-cardiac-muscle.jpg',
    quizBackgroundImage: 'unit/exam2-cardiac-muscle.jpg',
    renderStyle: 'hotspot',
  ...
  'smooth-muscle': {
    ...
    imageHeight: 1438,
    maxWidthClass: 'max-w-md',
    backgroundImage: 'unit/exam2-smooth-muscle.jpg',
    quizBackgroundImage: 'unit/exam2-smooth-muscle.jpg',
    renderStyle: 'hotspot',
    credit: credit('Smooth muscle'),
    regions: [
      tap('sm-fiber', 'Smooth muscle cell', 430, 720, 80, 'Fusiform, one nucleus, no striations, ANS.', 'Muscle'),
    ],
  },
  ...
  'hyaline-cartilage': {
    ...
    imageHeight: 1474,
    maxWidthClass: 'max-w-md',
    backgroundImage: 'unit/exam2-hyaline.jpg',
    quizBackgroundImage: 'unit/exam2-hyaline.jpg',
    renderStyle: 'hotspot',
  ...
  'areolar-ct': {
    ...
    imageHeight: 1467,
    maxWidthClass: 'max-w-md',
    backgroundImage: 'unit/exam2-areolar.jpg',
    quizBackgroundImage: 'unit/exam2-areolar.jpg',
    renderStyle: 'hotspot',
